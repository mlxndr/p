...
<table class="titlebr" width="100%">
    <tr>
        ...
        <td class="tpa4-r"><span style="font-variant-caps: all-small-caps;">ICAME47</span>, Koblenz<br><span class="subtle">May 2026</span></td>
    </tr>
    <tr style="padding-bottom: 5em; padding-top: 5em""><td colspan="2"><hr></td></tr>
    <tr>
        <td class="tpa4-l"><img src="../img/leverhulme_cmyk_black2.png" height="104em" alt="Leverhulme Trust Logo" class="theme-logo leverhulme-logo"></td>
        <td class="tpa4-r"><img src="../img/uog_mono.png" height="95em" alt="University of Glasgow Logo" class="theme-logo uog-logo"></td>
    </tr>
</table>