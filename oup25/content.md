...
* The HTE project: 1965-present
  * Many editors, generally carried out under the leadership of two people (both now deceased)
  * Work was flexible and emergent and rules not often written down but practice-based
  * We're trying to reconstruct it from documents and from our own heads...
* Principles all emerged from practice
  * Not imposed a priori, but discovered through engagement with data
...
* Based on structural semantics approach
  * Saussure's *valeur*: meaning exists only in relation to other meanings
  * von Humboldt: language as organic system of interrelated subsystems
* Key concept: The lexical field
  * "A system of sense-relations which... is nonetheless seen as having an identity of its own"
  * Example: "Religion" overlaps with "morality," "myth," "ritual observances"
...
* **"What's it for?" rather than "What is it?"**
  ...
  * Reflects human functional perspective, not philosophical taxonomy
* Example: Writing desk classification
...
* Classic example: *lava* and *volcanic ash*
  * Classified with VOLCANO, not with STONE or DUST
...
* Reverses Roget's approach (which began with abstract relations)
* Rationale: Historical development of language
  * Concrete terms likely preceded abstract
  * Metaphors for mental concepts derive from physical world
* Within categories:
...
* Original constraints of print format:
  * Brief category headings
  * Rigid hierarchical display
