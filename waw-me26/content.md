...
'Put at its simplest, its purpose is to provide a detailed record of the English vocabulary from the earliest times to the present, with sufficient accompanying information that, for any given period in the past, the user should be able to ascertain the exact state of the vocabulary (i.e. the 'lexical system') which existed at that time.'
<div style='font-size: 80%; text-align: right; font-style: italic;'>‘Why a Historical Thesaurus’</div><br>

* The claim: you can see what vocabulary was available at any point
* The complication: structures of the 'state of the vocabulary' are always from *some* perspective
...
## Specialisation as Spectrum

* 'Technical' vocabulary implies a binary: specialist vs general
